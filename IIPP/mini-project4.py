...
def draw(canvas):
    ...
    ball_pos = [ball_pos[0] + ball_vel[0],
    ...
    if(ball_pos[0] <= (BALL_RADIUS + PAD_WIDTH) or
        ...
        if ball_pos[0] > HALF_WIDTH:
            if(ball_pos[1] - BALL_RADIUS < paddle2_pos - HALF_PAD_HEIGHT or
               ball_pos[1] + BALL_RADIUS > paddle2_pos + HALF_PAD_HEIGHT):
                ...
                ball_vel[0] *= 1.1             
        if ball_pos[0] < HALF_WIDTH:
            if(ball_pos[1] - BALL_RADIUS < paddle1_pos - HALF_PAD_HEIGHT or
    ...
    if((paddle1_pos <= HEIGHT - HALF_PAD_HEIGHT and paddle1_vel > 0) or
       (paddle1_pos >= HALF_PAD_HEIGHT and paddle1_vel < 0)):
        paddle1_pos += paddle1_vel    
    elif((paddle2_pos <= HEIGHT - HALF_PAD_HEIGHT and paddle2_vel > 0) or
         (paddle2_pos >= HALF_PAD_HEIGHT and paddle2_vel < 0)):
    ...
    canvas.draw_text(str(score2), [550, 50], 60, "White")         
def keydown(key):
